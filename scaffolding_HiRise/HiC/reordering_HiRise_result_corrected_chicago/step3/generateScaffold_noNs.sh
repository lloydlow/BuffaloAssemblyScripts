...
# with no string of Ns (useful for fixed false breaks)
...
filename3order="hic"$var1"_"$var2"_"$var3".fa"
filename3orderwofa="hic"$var1"_"$var2"_"$var3

COMBINEFASTADIR="/Users/lloyd/Documents/lloyd_2017/Research/RiverBuffalo/scripts_derek/CombineFasta/store"

java -Xmx8000m -jar $COMBINEFASTADIR"/CombineFasta.jar" order -i contig_order.list -o $filename3order
