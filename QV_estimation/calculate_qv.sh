#!/usr/bin/bash
# QV metric development is credited to Serge Koren
# This script was written by Derek Bickhart and is released as free and open-source code to the public
#SBATCH --nodes=1
#SBATCH --mem=10000
#SBATCH --ntasks-per-node=1
#SBATCH -p short

# INPUT Cmd line arguments:
# $1 = vcf file
# $2 = input bam file
# $3 = output QV file

# Script dependencies:
# * samtools >= 1.4 with HTSLib
# * perl
# * optional: Slurm job submission system for use on a cluster environment
